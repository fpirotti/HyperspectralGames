...
Code available in GitHub [here](https://github.com/fpirotti/HyperspectralGames){target=_blank}
...
We read the two images that were previously cut (see file index.R which has some preprocessing steps)
