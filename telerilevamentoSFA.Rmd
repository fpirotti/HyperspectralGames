...
fluidRow(
  column(
    6,
    style = "margin:0; margin-bottom:10px; margin-left:5px; padding:0; width:680px !important;",
  ...
  column(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        fluidRow(
          ...
          column(
            ...
            div(
            style = "  margin-top:25px;", title="Calcola e disegna", shinyWidgets::actionBttn(
              inputId = "indexGo",
              label = NULL,
              icon =
                icon("pencil"),
            ...
            div(style = "  margin-top:25px;", title="Scarica un geotiff", shiny::downloadButton(
               "indexDownload",
              label = NULL 
            ) )
          )
      ...
      tabPanel("Classificazione",   value = "classificazione.panel",  div())
    )
  )
