...
Immagine Sentinel-2 L2A ripresa su Padova il giorno 24 aprile 2018. E' visibile Prato della Valle.
...
fluidRow(
  ...
  column( 6,    div( id="myresult",   class="img-zoom-result", div(style="border:2px solid red; width:10px; height:10px; margin:105px auto;  ") )  )
...
fluidRow( 
  ...
  column( 6,    plotlyOutput("graph1"), shiny::actionButton("resetGraph", "Reset Grafico Firme Spettrali") )
...
observeEvent(input$runTrain, {
 ...
 # saveRDS(react$train.table, "s2.train.table.rds")
  ...
  withProgress(message = "Intelligence going Artificial",
               ...
               value = 0,
               {
                 grid <-  as.h2o(as.data.frame(myImage))
